...
$sql= "SELECT dvd_title_id, title, release_date, genres.genre AS genre, sounds.sound AS sound, labels.label AS label, formats.format AS format, ratings.rating AS rating
FROM dvd_titles
	JOIN genres
			...
			<div class="col-12">
				<table class="table table-hover table-responsive mt-4">
					...
					<tbody>
						...
						<tr>
							<td> <a href="delete.php?dvd_title_id=<?php echo $row['dvd_title_id']?>&title=<?php echo $row['title']?>" role= "button" class="btn btn-danger">Delete</button></td>
							<td>
